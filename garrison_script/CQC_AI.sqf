...
if (isnil("fnc_Find_Closest")) then {
	...
	fnc_Find_Closest = compile preProcessFileLineNumbers "garrison_script\CQC_fncs\fnc_Find_Closest.sqf";
};

if (isnil("fnc_cqc_target")) then {
	fnc_cqc_target = compile preProcessFileLineNumbers "garrison_script\CQC_fncs\fnc_cqc_target.sqf";
	//hint "cqc target compiled";
};

if (isnil("CQC_AI_Close")) then {
	CQC_AI_Close = compile preProcessFileLineNumbers "garrison_script\CQC_fncs\CQC_AI_Close.sqf";
	//hint "cqc target compiled";
};

if (isnil("CQC_AI_Vision")) then {
	CQC_AI_Vision = compile preProcessFileLineNumbers "garrison_script\CQC_fncs\CQC_AI_Vision.sqf";
	//hint "cqc target compiled";
};

if (isnil("fnc_cqc_renew")) then {
	fnc_cqc_renew = compile preProcessFileLineNumbers "garrison_script\CQC_fncs\fnc_cqc_renew.sqf";
	//hint "cqc renew compiled";
};

if (isnil("fnc_cqc_react")) then {
	fnc_cqc_react = compile preProcessFileLineNumbers "garrison_script\CQC_fncs\fnc_cqc_react.sqf";
	//hint "cqc react compiled";
};

if (isnil("fnc_silenced")) then {
	fnc_silenced = compile preProcessFileLineNumbers "garrison_script\CQC_fncs\fnc_silenced.sqf";
	//hint "fnc_silenced compiled";
};

if (isnil("fnc_willseetarget")) then {
	fnc_willseetarget = compile preProcessFileLineNumbers "garrison_script\CQC_fncs\fnc_willseetarget.sqf";
	//hint "willseetarget compiled";
};

if (isnil("fnc_willseeincombat")) then {
	fnc_willseeincombat = compile preProcessFileLineNumbers "garrison_script\CQC_fncs\fnc_willseeincombat.sqf";
	//hint "fnc_willseeincombat compiled";
};

if (isnil("fnc_Intersect_Pos_Rough")) then {
	fnc_Intersect_Pos_Rough = compile preProcessFileLineNumbers "garrison_script\CQC_fncs\fnc_intersect_pos_rough.sqf";
	//hint "fnc_Intersect_Pos_Rough compiled";
};

if (isnil("fnc_get_DoorPositions")) then {
	// [_house]; returns doorpositionsin model coords;
	fnc_get_DoorPositions = compile preProcessFileLineNumbers "garrison_script\CQC_fncs\fnc_get_DoorPositions.sqf";
};
