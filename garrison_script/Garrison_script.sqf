...
{
	alertdebug = [] execVM "garrison_script\Garrison_fncs\alerted_debug.sqf";
};
*/
...
nul = [_group,_groupUnits] execVM "garrison_script\Garrison_fncs\leaving_check.sqf"; // leaving check;
...
if (isnil("fnc_vision_check")) then {
	fnc_vision_check = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_vision_check.sqf";
	//hint "fnc_vision_check compiled";
};

if (isnil("fnc_MoveTo")) then {
	// [_unit,_pos];
	fnc_MoveTo = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_MoveTo.sqf";
};

if (isnil("fnc_Patrol")) then {
	// [_leader,_patrolCenter,_patrolRadius,_bRepeating (after contact)];
	fnc_Patrol = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\patrol.sqf";
};

if (isnil("fnc_Prone_Limit")) then {
	// [_leader,_patrolCenter,_patrolRadius,_bRepeating (after contact)];
	fnc_Prone_Limit = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_Prone_Limit.sqf";
};

if (isnil("fnc_smartlook")) then {
	fnc_smartlook = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_smartlook.sqf";
	//hint "smartlook compiled";
};

if (isnil("fnc_seek")) then {
	fnc_seek= compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_seek.sqf";
	//hint "seek compiled";
};

if (isnil("fnc_get_angle")) then {
	fnc_get_angle = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_get_angle.sqf";
	//hint "get_angle compiled";
};

if (isnil("fnc_cansee")) then {
	fnc_cansee = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_cansee.sqf";
	//hint "cansee compiled";
};

if (isnil("fnc_get_DoorPositions")) then {
	// [_house]; returns doorpositionsin model coords;
	fnc_get_DoorPositions = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_get_DoorPositions.sqf";
};
...
if (isnil("fnc_willsee")) then {
	fnc_willsee = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_willsee.sqf";
	//hint "willsee compiled";
};


if (isnil("fnc_willwalk")) then {
	fnc_willwalk = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_willwalk.sqf";
	//hint "willwalk compiled";
};

if (isnil("fnc_indoors")) then {
	fnc_indoors = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_indoors.sqf";
	//hint "indoors compiled";
};

if (isnil("fnc_sillybuild_check")) then {
	fnc_sillybuild_check = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_sillybuild_check.sqf";
	//hint "sillybuild check compiled";
};
/*
if (isnil("fnc_cqc_target")) then {
	fnc_cqc_target = compile preProcessFileLineNumbers "garrison_script\Garrison_fncs\fnc_cqc_target.sqf";
	//hint "cqc target compiled";
};
*/
if (isnil("CQC_AI")) then {
	// [_unit]
	CQC_AI = compile preProcessFileLineNumbers "garrison_script\CQC_AI.sqf";
